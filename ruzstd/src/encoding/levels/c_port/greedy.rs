...
pub(super) use lazy::compress_block_lazy_generic_with_state;
...
pub(crate) fn compress_block_btlazy2_no_dict_with_state_and_loaded_dict(
    ...
    lazy::compress_block_lazy_generic_no_dict_with_state::<SEARCH_BINARY_TREE>(
        src,
        block_range,
        params,
        repeat_offsets,
...
fn compress_block_hash_chain_no_dict_with_state(
    ...
    lazy::compress_block_lazy_generic_no_dict_with_state::<SEARCH_HASH_CHAIN>(
        src,
        block_range,
        params,
        repeat_offsets,
...
fn compress_block_hash_or_row_no_dict_with_state(
    ...
    if row_match_finder_enabled(params) {
        lazy::compress_block_lazy_generic_no_dict_with_state::<SEARCH_ROW_HASH>(
            src,
            block_range,
            params,
            repeat_offsets,
