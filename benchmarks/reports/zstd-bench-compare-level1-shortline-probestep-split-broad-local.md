...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-shortline-probestep-split-broad-local.csv`
...
repo_main.rs                            2,141           2,101      2,181      -1.9%          0.00s         0.00s  0.00s    +0.0%        
repo_match_generator.rs                 22,591          22,797     22,883     -1.3%          0.00s         0.00s  0.00s    +0.0%        
```
