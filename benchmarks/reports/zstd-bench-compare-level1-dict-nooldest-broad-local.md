...
Commentary: DictionaryText only: skip oldest window candidates to test whether the remaining dictionary gap is coming from expensive far-offset matches rather than useful newest/rep matches.
...
dict_dictionary.bin                     20,175          20,145     22,657     -12.3%         0.00s         0.00s  0.00s    +0.0%        
