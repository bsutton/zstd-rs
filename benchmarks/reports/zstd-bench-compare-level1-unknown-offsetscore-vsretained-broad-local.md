...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-offsetscore-vsretained-broad-local.csv`

Commentary: Large Unknown Fastest path: prefer smaller-offset non-repeat candidates when they save at least 2 offset-code bits for at most 1 byte of match loss, regardless of start position.
