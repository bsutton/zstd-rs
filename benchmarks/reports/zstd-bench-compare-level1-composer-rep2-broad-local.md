...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-composer-rep2-broad.csv`

Commentary: composer repeat-kind match-loss vs retained baseline
...
-------------------------------------  --------------  ---------  ---------  -------------  ------------  -----  -------  -------------
build_libruzstd.rlib                   611,155         635,879    611,155    +0.0%          0.05s         0.00s  0.05s    +0.0%        
build_ruzstd-cli                       897,122         932,141    897,122    +0.0%          0.08s         0.00s  0.08s    +0.0%        
decodecorpus_z000003                   50,898          53,328     50,898     +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000028                   95,230          105,226    95,230     +0.0%          0.00s         0.00s  0.01s    +0.0%        
...
decodecorpus_z000033                   530,433         571,529    530,433    +0.0%          0.04s         0.00s  0.04s    +0.0%        
...
generated_Gemfile.lock                 239             252        239        +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_WORKSPACE                    201             208        201        +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_buf.yaml                     187             189        187        +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_composer.lock                4,119           3,766      4,112      +0.2%          0.00s         0.00s  0.00s    +0.0%        
generated_cross_block_001m.bin         6,358           6,587      6,358      +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_deno.json                    2,484           2,391      2,484      +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_go.mod                       164             168        164        +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_go.sum                       151             154        151        +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_json_logs_001m.jsonl         58,767          59,118     58,767     +0.0%          0.01s         0.00s  0.01s    +0.0%        
generated_nx.json                      2,484           2,391      2,484      +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_package-lock.json            4,381           4,414      4,381      +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_package.json                 3,785           3,826      3,785      +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_pipfile.lock                 2,804           3,167      2,804      +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_poetry.lock                  358             362        358        +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_pom.xml                      196             195        196        +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_pubspec.lock                 229             227        229        +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
generated_tsconfig.json                2,484           2,391      2,484      +0.0%          0.00s         0.00s  0.00s    +0.0%        
generated_turbo.json                   3,785           3,826      3,785      +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
repo_Cargo.lock                        9,104           8,088      9,104      +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
repo_match_generator.rs                27,845          28,782     27,845     +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_prepare_benchmark_suites.py       6,827           7,081      6,827      +0.0%          0.00s         0.00s  0.00s    +0.0%        
