...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-cargolockcode-broad-local.csv`

Commentary: Map Cargo.lock to the CodeText starting point instead of generic ConfigText at level 1.
