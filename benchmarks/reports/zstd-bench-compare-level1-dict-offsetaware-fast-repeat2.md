...
Commentary: Repeat run for DictionaryText same-start smaller-offset preference when offset-code savings are real, after hoisting the dictionary gate out of generic comparison.
