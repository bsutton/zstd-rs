...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-archive-dense-start-broad-local.csv`

Commentary: Level-1 file-type starting point: archive-like binaries use dense non-text probing across block sizes; all other file families keep the retained baseline behavior.
