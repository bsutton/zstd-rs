...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-dict-broader-offset-broad-local.csv`

Commentary: DictionaryText prefers smaller-offset non-repeat candidates when they save at least four offset-code bits at a cost of at most one match byte.
