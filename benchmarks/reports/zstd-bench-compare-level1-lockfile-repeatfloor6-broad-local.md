...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-lockfile-repeatfloor6-broad-local.csv`

Commentary: Require one extra match byte for repeat candidates only on the retained lockfile-specific DictionaryText path.
...
build_ruzstd-cli                       866,125         916,669    866,125    +0.0%          0.07s         0.00s  0.07s    +0.0%        
...
generated_poetry.lock                  362             362        362        +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
generated_yarn.lock                    390             393        390        +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_.gitignore                        172             164        172        +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_Cargo.lock                        9,114           8,088      9,117      -0.0%          0.00s         0.00s  0.00s    +0.0%        
...
repo_compressed.rs                     13,031          13,102     13,031     +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_main.rs                           2,125           2,142      2,125      +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_match_generator.rs                27,879          28,622     27,879     +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_prepare_benchmark_suites.py       3,814           3,850      3,814      +0.0%          0.00s         0.00s  0.00s    +0.0%        
