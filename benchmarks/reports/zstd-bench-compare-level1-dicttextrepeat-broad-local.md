...
Source CSV: `benchmarks/archive/tmp/dicttextrepeat-broad-local.csv`

Commentary: DictionaryText text blocks use the best-text repeat pipeline at level 1.
...
build_ruzstd-cli                       862,752         906,038    862,752    +0.0%          0.09s         0.01s  0.06s    +33.3%       
