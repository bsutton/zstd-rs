...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-smalltext7-vs8-broad-local.csv`
...
build_ruzstd-cli                        867,739         894,099    866,832    +0.1%          0.05s         0.00s  0.05s    +0.0%        
...
decodecorpus_z000079                    8,372           7,221      8,378      -0.1%          0.00s         0.00s  0.00s    +0.0%        
...
repo_match_generator.rs                 23,717          22,797     22,876     +3.5%          0.00s         0.00s  0.00s    +0.0%        
```
