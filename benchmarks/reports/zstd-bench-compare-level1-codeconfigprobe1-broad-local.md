...
Commentary: CodeText and ConfigText, short-line only, <=8 KiB: force dense no-match probing (step 1) to see if small config/service losses can fall after the retained repo_main CodeText win.
...
dict_systemd-coredump@.service          690             684        686        +0.6%          0.00s         0.00s  0.00s    +0.0%        
dict_systemd-logind.service             1,134           1,120      1,122      +1.1%          0.00s         0.00s  0.00s    +0.0%        
