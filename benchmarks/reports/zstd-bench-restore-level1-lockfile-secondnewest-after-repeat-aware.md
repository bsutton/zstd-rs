...
Source CSV: `benchmarks/archive/tmp/restore-lockfile-secondnewest-after-repeat-aware.csv`

Commentary: Restore check after rejecting lockfile repeat-aware same-start tie-break.
...
dict_dictionary.bin                    20,160          20,145     20,160     +0.0%          0.57s         0.00s  0.69s    -21.1%       
