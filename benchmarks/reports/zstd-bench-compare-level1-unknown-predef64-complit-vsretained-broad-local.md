...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-predef64-complit-vsretained-broad-local.csv`

Commentary: Unknown level-1: allow predefined LL/ML tables up to 64 sequences for Unknown blocks only when literals are in the compressed-literals path, on top of retained newestgain2 baseline.
...
decodecorpus_z000053                    322             299        304        +5.6%          0.00s         0.00s  0.00s    +0.0%        
