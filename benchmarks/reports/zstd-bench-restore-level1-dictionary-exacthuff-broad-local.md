...
Source CSV: `benchmarks/reports/zstd-bench-restore-level1-dictionary-exacthuff-broad-local.csv`

Commentary: Restore check after enabling DictionaryText exact-Huffman literal search; compare live source tree against the retained level-1 small-second-newest baseline.
...
decodecorpus_z000033                    544,266         571,529    544,266    +0.0%          0.02s         0.00s  0.01s    +50.0%       
