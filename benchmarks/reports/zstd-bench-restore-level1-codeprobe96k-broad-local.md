...
Source CSV: `benchmarks/archive/tmp/restore-codeprobe96k-broad-local.csv`

Commentary: Restore check after rejecting small-sequence DictionaryText OF max-log 6.
...
build_ruzstd-cli                       862,752         906,038    862,752    +0.0%          0.07s         0.00s  0.07s    +0.0%        
