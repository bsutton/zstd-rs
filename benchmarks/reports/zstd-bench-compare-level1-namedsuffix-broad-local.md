...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-namedsuffix-broad-local.csv`

Commentary: Allow well-known filename families to match by suffix with a separator so synthetic fixture names still hit their intended file-type policy.
...
repo_Cargo.lock                        9,255           8,088      9,255      +0.0%          0.00s         0.00s  0.00s    +0.0%        
