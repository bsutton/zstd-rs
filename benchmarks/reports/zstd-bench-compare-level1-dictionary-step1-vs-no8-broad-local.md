...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-dictionary-step1-vs-no8-broad-local.csv`

Commentary: Experiment: DictionaryText uses a fully dense no-match probe step of 1 instead of the generic short-line step 2.
...
build_ruzstd-cli                        856,479         894,099    856,479    +0.0%          0.06s         0.00s  0.05s    +16.7%       
decodecorpus_z000003                    51,006          53,328     51,006     +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000028                    98,656          105,226    98,656     +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000033                    532,424         571,529    532,424    +0.0%          0.02s         0.00s  0.02s    +0.0%        
...
decodecorpus_z000079                    7,518           7,221      7,518      +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
dict_dictionary.bin                     20,667          20,145     20,175     +2.4%          0.00s         0.00s  0.00s    +0.0%        
