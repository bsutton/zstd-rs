...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-lockname-trim-broad-local.csv`

Commentary: Keep lockfile name expansion evidence-based: remove poetry.lock and yarn.lock from DictionaryText mapping.
...
generated_poetry.lock                  371             362        371        +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
generated_yarn.lock                    398             393        398        +0.0%          0.00s         0.00s  0.00s    +0.0%        
