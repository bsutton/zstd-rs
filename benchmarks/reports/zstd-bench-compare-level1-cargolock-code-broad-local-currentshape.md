...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-cargolock-code-broad-local-currentshape.csv`

Commentary: Map Cargo.lock to CodeText on the current retained parser shape.
...
repo_Cargo.lock                        9,114           8,088      9,240      -1.4%          0.00s         0.00s  0.00s    +0.0%        
