...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-cargolockcode-live-broad-local.csv`

Commentary: With suffix-based named-file matching active, map Cargo.lock to the CodeText starting point at level 1.
