...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-dense64-broad-local.csv`

Commentary: Experiment: lower the dense long-match indexing limit only for Fastest Unknown non-text blocks from 128 to 64.
...
build_ruzstd-cli                        860,072         894,099    859,309    +0.1%          0.05s         0.00s  0.05s    +0.0%        
decodecorpus_z000003                    52,134          53,328     52,176     -0.1%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000028                    100,250         105,226    100,296    -0.0%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000033                    544,266         571,529    544,408    -0.0%          0.02s         0.00s  0.02s    +0.0%        
decodecorpus_z000053                    322             299        322        +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000054                    9,567           9,999      9,569      -0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000059                    711             698        710        +0.1%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000062                    13              13         13         +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000077                    21              21         21         +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000079                    7,540           7,221      7,548      -0.1%          0.00s         0.00s  0.00s    +0.0%        
