...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-cargolock-config-broad-local.csv`

Commentary: Map Cargo.lock to ConfigText instead of DictionaryText.
...
repo_Cargo.lock                        9,114           8,088      9,255      -1.5%          0.00s         0.00s  0.00s    +0.0%        
