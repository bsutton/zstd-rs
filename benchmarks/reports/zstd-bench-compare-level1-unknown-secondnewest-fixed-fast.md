...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-secondnewest-fixed-fast.csv`

Commentary: Guardrail check: Fastest Unknown non-text second-newest extension against the fast fixture set.
