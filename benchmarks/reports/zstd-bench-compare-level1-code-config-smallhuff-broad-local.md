...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-code-config-smallhuff-broad-local.csv`

Commentary: Test a file-type starting point that broadens exact Huffman table search for small CodeText and ConfigText literal sections while leaving JSON and the matcher path unchanged.
...
dict_NetworkManager-dispatcher.service  395             384        391        +1.0%          0.00s         0.00s  0.00s    +0.0%        
...
dict_fstrim.service                     312             295        308        +1.3%          0.00s         0.00s  0.00s    +0.0%        
dict_ftpd.service                       172             164        168        +2.3%          0.00s         0.00s  0.00s    +0.0%        
dict_kmod-static-nodes.service          497             483        497        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_netctl@.service                    212             210        206        +2.8%          0.00s         0.00s  0.00s    +0.0%        
dict_systemd-coredump@.service          692             684        690        +0.3%          0.00s         0.00s  0.00s    +0.0%        
dict_systemd-logind.service             1,134           1,120      1,134      +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_systemd-udev-settle.service        569             558        568        +0.2%          0.00s         0.00s  0.00s    +0.0%        
...
repo_main.rs                            2,141           2,101      2,137      +0.2%          0.00s         0.00s  0.00s    +0.0%        
