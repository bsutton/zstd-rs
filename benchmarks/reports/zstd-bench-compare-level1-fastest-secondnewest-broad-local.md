...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-fastest-secondnewest-broad-local.csv`

Commentary: Level-1 binary-path experiment: track a current-entry second-newest candidate for large Fastest non-text blocks on top of the retained ip+1 repeat lookahead.
...
--------------------------------------  --------------  ---------  ---------  -------------  ------------  -----  -------  -------------
build_libruzstd.rlib                    611,155         635,879    609,561    +0.3%          0.03s         0.00s  0.04s    -33.3%       
build_ruzstd-cli                        860,072         894,099    856,479    +0.4%          0.05s         0.00s  0.06s    -20.0%       
decodecorpus_z000003                    52,134          53,328     51,006     +2.2%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000028                    100,250         105,226    98,656     +1.6%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000033                    544,266         571,529    532,424    +2.2%          0.02s         0.00s  0.02s    +0.0%        
decodecorpus_z000053                    324             299        324        +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000054                    9,756           9,999      9,628      +1.3%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000079                    7,540           7,221      7,518      +0.3%          0.00s         0.00s  0.00s    +0.0%        
