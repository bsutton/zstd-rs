...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/tmp/cargolockoffset2-broad-local.csv`

Commentary: DictionaryText: for Cargo-lock-like text only, allow the smaller-offset same-start non-repeat candidate to win with up to 2 bytes of match loss.
...
repo_Cargo.lock                        9,240           8,088      9,243      -0.0%          0.00s         0.00s  0.00s    +0.0%        
