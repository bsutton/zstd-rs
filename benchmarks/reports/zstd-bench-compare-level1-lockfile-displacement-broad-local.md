...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/tmp/lockfile-displacement-broad-local.csv`

Commentary: Prefer closer current non-repeat candidates over farther newest/oldest window hits for Cargo.lock-like DictionaryText blocks.
...
decodecorpus_z000033                   532,632         571,529    532,632    +0.0%          0.03s         0.00s  0.03s    +0.0%        
...
dict_dictionary.bin                    20,160          20,145     20,160     +0.0%          0.58s         0.00s  0.57s    +1.7%        
