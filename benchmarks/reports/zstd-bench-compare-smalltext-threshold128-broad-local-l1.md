...
Source CSV: `benchmarks/reports/zstd-bench-compare-smalltext-threshold128-broad-local-l1.csv`

Commentary: Level-1 experiment: classify printable blocks as text starting at 128 bytes instead of 1024, targeting small text and dictionary-style losses in the broad-local suite.
...
build_ruzstd-cli                        870,526         894,099    870,526    +0.0%          0.04s         0.00s  0.04s    +0.0%        
...
dict_NetworkManager-dispatcher.service  400             384        403        -0.8%          0.00s         0.00s  0.00s    +0.0%        
dict_dictionary.bin                     25,598          20,145     25,598     +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_e2scrub_reap.service               383             378        387        -1.0%          0.00s         0.00s  0.00s    +0.0%        
dict_fstrim.service                     304             295        311        -2.3%          0.00s         0.00s  0.00s    +0.0%        
dict_ftpd.service                       172             164        172        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_kmod-static-nodes.service          499             483        509        -2.0%          0.00s         0.00s  0.00s    +0.0%        
dict_netctl@.service                    214             210        240        -12.1%         0.00s         0.00s  0.00s    +0.0%        
...
dict_systemd-udev-settle.service        572             558        587        -2.6%          0.00s         0.00s  0.00s    +0.0%        
