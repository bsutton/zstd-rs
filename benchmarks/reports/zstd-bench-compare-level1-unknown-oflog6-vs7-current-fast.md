...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-oflog6-vs7-current-fast.csv`

Commentary: Unknown level-1: compare offset FSE max-log 6 against 7 on top of the retained large-Unknown oldest-displacement +2 rule, on fast guardrails.
