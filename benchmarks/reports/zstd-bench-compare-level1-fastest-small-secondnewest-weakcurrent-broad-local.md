...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-fastest-small-secondnewest-weakcurrent-broad-local.csv`

Commentary: Level-1 binary-path experiment: let small-block Fastest current-entry second_newest compete when the current candidate is a weak minimum-length non-repeat match.
