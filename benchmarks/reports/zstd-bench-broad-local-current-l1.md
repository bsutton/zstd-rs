...
Source CSV: `benchmarks/reports/zstd-bench-broad-local-current-l1.csv`

Commentary: Broad local suite rerun on the current tree to check whether level-1 compression remains comparable to C before pivoting effort toward CPU.
...
build_ruzstd-cli                        870,526         894,099    870,526    +0.0%          0.05s         0.00s  0.04s    +20.0%       
