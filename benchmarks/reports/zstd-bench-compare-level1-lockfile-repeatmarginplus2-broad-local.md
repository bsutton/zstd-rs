...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-lockfile-repeatmarginplus2-broad-local.csv`

Commentary: Increase repeat-vs-normal match margin only on the retained lockfile-specific DictionaryText path.
...
build_ruzstd-cli                       866,125         916,669    866,125    +0.0%          0.07s         0.00s  0.06s    +14.3%       
