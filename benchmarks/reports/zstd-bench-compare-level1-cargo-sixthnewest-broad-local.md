...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-cargo-sixthnewest-broad-local.csv`

Commentary: current source vs retained cargo-fifthnewest baseline
...
repo_Cargo.lock                        9,065           8,088      9,051      +0.2%          0.00s         0.00s  0.00s    +0.0%        
