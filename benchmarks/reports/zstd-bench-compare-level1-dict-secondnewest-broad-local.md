...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-dict-secondnewest-broad-local.csv`

Commentary: Generic DictionaryText current-entry second_newest
