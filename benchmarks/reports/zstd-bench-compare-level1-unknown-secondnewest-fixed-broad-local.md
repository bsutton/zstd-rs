...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-secondnewest-fixed-broad-local.csv`

Commentary: Experiment: extend the retained Fastest small-block second-newest path to Unknown non-text blocks up to 128 KiB, with matching probe gating.
