...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-hufftable-adaptive-broad-local.csv`

Commentary: Level-1 experiment: adaptively choose the smaller Huffman weight-table encoding (direct vs FSE) to reduce literal-table description overhead on small known-file-type literals.
