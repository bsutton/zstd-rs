...
Source CSV: `benchmarks/archive/tmp/dictsmalloflog6-broad-local.csv`

Commentary: DictionaryText: for small-sequence blocks only, lower offset FSE max-log from 7 to 6.
...
repo_Cargo.lock                        9,240           8,088      9,292      -0.6%          0.00s         0.00s  0.00s    +0.0%        
