...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-oldestgain2-fast.csv`

Commentary: Large Unknown Fastest: require a farther oldest candidate to gain at least 2 bytes before displacing a closer current-window match on fast guardrails.
