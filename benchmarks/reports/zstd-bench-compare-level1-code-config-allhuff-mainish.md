...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-code-config-allhuff-mainish.csv`

Commentary: Focused check: CodeText and ConfigText exact Huffman on all literal sections versus retained small-literal file-type policy.
