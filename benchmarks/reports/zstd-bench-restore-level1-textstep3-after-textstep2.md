...
Source CSV: `benchmarks/reports/zstd-bench-restore-level1-textstep3-after-textstep2.csv`

Commentary: Restore check after reverting the rejected level-1 text no-match probe step 2 experiment.
...
build_ruzstd-cli                        867,739         894,099    865,409    +0.3%          0.05s         0.00s  0.06s    -20.0%       
