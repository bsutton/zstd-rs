...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/tmp/cargolockfloor7-broad-local.csv`

Commentary: DictionaryText: detect Cargo-lock-like short-line text and raise the non-repeat floor from 5 to 7 only for that content.
