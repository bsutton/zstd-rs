...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-config-predef24-complit-of-vsretained-broad-local.csv`

Commentary: ConfigText level-1: on top of the retained compressed-literals LL/ML gate, allow predefined OF tables only up to 24 sequences.
