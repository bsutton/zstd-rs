...
Commentary: Large Unknown Fastest path: let ip+1 repeat lookahead run not only against exact 5-byte current non-repeat hits, but also against short current non-repeat hits up to 8 bytes, to test the remaining z000079 adjacent-repeat gap.
