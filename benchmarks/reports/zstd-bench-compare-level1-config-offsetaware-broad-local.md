...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-config-offsetaware-broad-local.csv`

Commentary: Small ConfigText blocks prefer same-start smaller offsets when they save at least two offset-code bits at a cost of at most one match byte.
...
dict_virtqemud.service                 672             673        671        +0.1%          0.00s         0.00s  0.00s    +0.0%        
