...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-config-forcedtext-broad-local.csv`

Commentary: Small ConfigText blocks up to 1024 bytes are treated as text for matching at level 1.
