...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/tmp/lockfiletext-restore-broad-local.csv`

Commentary: Restore check after rejecting LockfileText and rebuilding the retained baseline.
...
repo_Cargo.lock                        9,240           8,088      9,240      +0.0%          0.00s         0.00s  0.00s    +0.0%        
