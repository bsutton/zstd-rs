...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-code-smallfloor5-broad-local.csv`

Commentary: CodeText short-line blocks up to 16 KiB use a 5-byte non-repeat floor instead of 6 at level 1.
...
decodecorpus_z000033                   532,632         571,529    532,632    +0.0%          0.03s         0.00s  0.02s    +33.3%       
...
repo_benchmark_zstd.py                 2,846           2,845      2,814      +1.1%          0.00s         0.00s  0.00s    +0.0%        
...
repo_progress.rs                       3,147           3,124      3,125      +0.7%          0.00s         0.00s  0.00s    +0.0%        
```
