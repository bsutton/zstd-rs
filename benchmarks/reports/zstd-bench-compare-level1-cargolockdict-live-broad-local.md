...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-cargolockdict-live-broad-local.csv`

Commentary: With suffix-based named-file matching active, map Cargo.lock to the DictionaryText starting point at level 1.
...
repo_Cargo.lock                        9,255           8,088      9,240      +0.2%          0.00s         0.00s  0.00s    +0.0%        
