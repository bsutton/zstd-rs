...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-oflog7-current-vsretained-fast.csv`

Commentary: Unknown level-1: lower offset FSE max-log from 8 to 7 on top of the retained large-Unknown oldest-displacement +2 rule, on fast guardrails.
...
---------------------  --------------  ----------  ----------  -------------  ------------  -----  -------  -------------
build_ruzstd-cli       855,782         894,099     855,822     -0.0%          0.06s         0.00s  0.06s    +0.0%        
