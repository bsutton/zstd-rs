...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-lockfile-secondnewestfirst-broad-local.csv`

Commentary: Lockfile-specific current-window probe order: second_newest before newest.
...
repo_Cargo.lock                        9,170           8,088      9,116      +0.6%          0.00s         0.00s  0.00s    +0.0%        
