...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-dict-oflog6-vs7-broad-local.csv`

Commentary: DictionaryText: compare offset FSE max-log 6 against 7.
