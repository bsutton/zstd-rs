...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-codeprobe64k-broad-local.csv`

Commentary: CodeText short-line dense probing widened from 10 KiB to 64 KiB at level 1.
...
dict_canberra-system-bootup.service    316             317        316        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_dictionary.bin                    20,160          20,145     20,160     +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_git-daemon@.service               248             247        248        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_glustereventsd.service            292             293        292        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_gpm.service                       191             193        191        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_quotaon.service                   420             420        420        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_systemd-journal-gatewayd.service  630             631        630        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_systemd-logind.service            1,122           1,120      1,122      +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_systemd-rfkill.service            469             470        469        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_talk.service                      160             154        160        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_telnet@.service                   113             114        113        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_virtlockd.service                 450             458        450        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_virtlogd.service                  535             543        535        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_virtqemud.service                 672             673        672        +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_virtsecretd.service               316             320        316        +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
repo_Cargo.toml                        737             726        737        +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_benchmark_zstd.py                 2,846           2,845      2,846      +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_compressed.rs                     12,839          12,752     12,695     +1.1%          0.00s         0.00s  0.00s    +0.0%        
repo_main.rs                           2,128           2,142      2,128      +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_match_generator.rs                26,253          26,851     26,192     +0.2%          0.00s         0.00s  0.00s    +0.0%        
repo_prepare_benchmark_suites.py       2,291           2,347      2,291      +0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_progress.rs                       3,147           3,124      3,147      +0.0%          0.00s         0.00s  0.00s    +0.0%        
```
