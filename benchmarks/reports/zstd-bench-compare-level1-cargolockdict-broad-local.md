...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-cargolockdict-broad-local.csv`

Commentary: Map Cargo.lock to the DictionaryText starting point instead of generic ConfigText at level 1.
