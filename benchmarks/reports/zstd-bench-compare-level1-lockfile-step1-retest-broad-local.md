...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-lockfile-step1-retest-broad-local.csv`

Commentary: Retest dense lockfile probing (step 1) on the current retained lockfile parser shape.
...
build_ruzstd-cli                       866,125         916,669    866,125    +0.0%          0.07s         0.00s  0.09s    -28.6%       
...
repo_Cargo.lock                        9,114           8,088      9,118      -0.0%          0.00s         0.00s  0.00s    +0.0%        
