...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-restore-level1-unknown-newestgain2-after-tinyseq.csv`

Commentary: Restore check after rejecting tiny-sequence-only Unknown oflog6 and restoring retained newestgain2 baseline.
...
decodecorpus_pack.bin  5,319,265       5,385,951   5,319,265   +0.0%          0.23s         0.05s  0.22s    +4.3%        
