...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-huffweight-maxlog5-broad-local.csv`

Commentary: Adaptive Huffman weight-table FSE max-log 6 vs 5 versus fixed 6 on the current retained level-1 baseline.
...
build_ruzstd-cli                       866,125         916,669    866,118    +0.0%          0.07s         0.00s  0.07s    +0.0%        
...
repo_match_generator.rs                27,879          28,622     27,877     +0.0%          0.00s         0.00s  0.00s    +0.0%        
