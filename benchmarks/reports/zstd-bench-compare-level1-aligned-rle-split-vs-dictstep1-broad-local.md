...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-aligned-rle-split-vs-dictstep1-broad-local.csv`

Commentary: Experiment: split exactly one trailing 32 KiB RLE block when a full Fastest Unknown non-text block ends with a 32 KiB repeated suffix that continues into the next block.
...
build_ruzstd-cli                        856,479         894,099    856,479    +0.0%          0.06s         0.00s  0.06s    +0.0%        
...
decodecorpus_z000079                    7,518           7,221      7,522      -0.1%          0.00s         0.00s  0.00s    +0.0%        
