...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-code-allsections-broad-local.csv`

Commentary: CodeText now searches exact Huffman tables for all literal sections at level 1.
...
repo_match_generator.rs                26,253          26,851     26,253     +0.0%          0.00s         0.00s  0.00s    +0.0%        
