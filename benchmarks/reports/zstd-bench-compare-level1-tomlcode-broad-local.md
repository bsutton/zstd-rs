...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-tomlcode-broad-local.csv`

Commentary: Map .toml files to the CodeText starting point instead of generic ConfigText at level 1.
...
repo_Cargo.toml                        730             726        732        -0.3%          0.00s         0.00s  0.00s    +0.0%        
