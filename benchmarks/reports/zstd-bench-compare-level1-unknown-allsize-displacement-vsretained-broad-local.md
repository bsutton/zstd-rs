...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-allsize-displacement-vsretained-broad-local.csv`

Commentary: Unknown level-1: extend retained newest/oldest displacement rules from large Unknown blocks to all Unknown non-text blocks.
...
decodecorpus_z000003                    51,012          53,328     51,001     +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000028                    98,381          105,226    98,383     -0.0%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000033                    532,632         571,529    532,626    +0.0%          0.02s         0.00s  0.02s    +0.0%        
decodecorpus_z000053                    322             299        322        +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000054                    9,567           9,999      9,565      +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000059                    711             698        709        +0.3%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000080                    2,603           2,613      2,602      +0.0%          0.00s         0.00s  0.00s    +0.0%        
