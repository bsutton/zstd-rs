...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-oflog6-vs7-current-broad-local.csv`

Commentary: Unknown level-1: compare offset FSE max-log 6 against 7 on top of the retained large-Unknown oldest-displacement +2 rule.
...
build_ruzstd-cli                        855,822         894,099    860,261    -0.5%          0.06s         0.00s  0.06s    +0.0%        
decodecorpus_z000003                    51,012          53,328     51,415     -0.8%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000028                    98,381          105,226    99,405     -1.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000030                    13,152          14,106     13,156     -0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000031                    112             127        112        +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000033                    532,650         571,529    536,771    -0.8%          0.02s         0.00s  0.02s    +0.0%        
decodecorpus_z000053                    322             299        324        -0.6%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000054                    9,567           9,999      9,589      -0.2%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000059                    711             698        714        -0.4%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000062                    13              13         13         +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000077                    21              21         21         +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000079                    7,321           7,221      7,413      -1.3%          0.00s         0.00s  0.00s    +0.0%        
