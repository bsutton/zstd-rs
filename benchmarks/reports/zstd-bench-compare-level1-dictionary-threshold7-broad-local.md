...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-dictionary-threshold7-broad-local.csv`

Commentary: Raised DictionaryText non-repeat floor from 5 to 7 while keeping the retained dense probe step, to reduce dictionary overmatching without touching Unknown binary or JSON paths.
...
dict_dictionary.bin                     20,175          20,145     21,619     -7.2%          0.00s         0.00s  0.00s    +0.0%        
