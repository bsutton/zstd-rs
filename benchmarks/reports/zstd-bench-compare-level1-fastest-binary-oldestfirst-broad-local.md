...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-fastest-binary-oldestfirst-broad-local.csv`

Commentary: Level-1 binary-path experiment: use oldest-first window probing for Fastest only on non-text blocks, leaving the retained short-line text path unchanged.
