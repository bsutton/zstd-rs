...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-dictionary-no8-vs-live-broad-local.csv`

Commentary: Experiment: remove the DictionaryText threshold-8 override and compare against the live retained baseline.
...
dict_dictionary.bin                     23,871          20,145     20,667     +13.4%         0.00s         0.00s  0.00s    +0.0%        
