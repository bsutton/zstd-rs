...
Source CSV: `benchmarks/archive/tmp/restore-lockfile-secondnewest-after-repeatbias.csv`

Commentary: Restore check after rejecting lockfile repeat-margin increase.
...
dict_dictionary.bin                    20,160          20,145     20,160     +0.0%          0.57s         0.00s  0.57s    +0.0%        
