...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-fastest-binary-nextrep-broad-local.csv`

Commentary: Level-1 binary-path experiment: enable ip+1 repeat lookahead for Fastest only on non-text blocks, leaving the retained short-line text path unchanged.
...
decodecorpus_z000003                    52,047          53,328     52,134     -0.2%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000028                    100,347         105,226    100,250    +0.1%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000033                    544,118         571,529    544,266    -0.0%          0.02s         0.00s  0.01s    +50.0%       
decodecorpus_z000053                    324             299        324        +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000054                    9,720           9,999      9,756      -0.4%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000059                    719             698        717        +0.3%          0.00s         0.00s  0.00s    +0.0%        
...
generated_cross_block_001m.bin          6,359           6,587      6,358      +0.0%          0.00s         0.00s  0.00s    +0.0%        
