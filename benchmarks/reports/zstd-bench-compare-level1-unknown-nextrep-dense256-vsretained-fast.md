...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-nextrep-dense256-vsretained-fast.csv`

Commentary: Large Unknown Fastest path: give repeat-next-position wins a denser post-match suffix insertion limit of 256 instead of the default 128.
...
---------------------  --------------  ----------  ----------  -------------  ------------  -----  -------  -------------
build_ruzstd-cli       855,679         894,099     855,635     +0.0%          0.06s         0.00s  0.06s    +0.0%        
...
json_logs_32m.jsonl    690,084         1,138,701   690,084     +0.0%          0.16s         0.04s  0.18s    -12.5%       
