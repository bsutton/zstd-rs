...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-newestbits-vsretained-broad-local.csv`

Commentary: Large Unknown level-1: require an extra byte from farther newest candidates only when they also cost at least 4 more offset-code bits.
...
build_ruzstd-cli                        855,679         894,099    855,725    -0.0%          0.06s         0.00s  0.06s    +0.0%        
