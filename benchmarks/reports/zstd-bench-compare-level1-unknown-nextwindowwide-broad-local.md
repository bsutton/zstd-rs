...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-nextwindowwide-broad-local.csv`

Commentary: Large Unknown Fastest: widen ip+1 window promotion from exact-minimum current non-repeat to short current non-repeat matches up to 8 bytes.
...
decodecorpus_z000028                    98,567          105,226    98,567     +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000033                    532,592         571,529    532,592    +0.0%          0.02s         0.00s  0.02s    +0.0%        
