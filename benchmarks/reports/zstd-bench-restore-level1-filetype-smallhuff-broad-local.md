...
Source CSV: `benchmarks/reports/zstd-bench-restore-level1-filetype-smallhuff-broad-local.csv`

Commentary: Restore check after rejecting follow-up entropy and framing experiments; compare the live tree against the retained level-1 filetype-smallhuff baseline.
