...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-tinyseq-oflog6-vsretained-broad-local.csv`

Commentary: Unknown level-1: use oflog6 only for tiny-sequence-count Unknown blocks (<=256 sequences) on top of retained newestgain2 baseline.
...
decodecorpus_z000079                    7,321           7,221      7,325      -0.1%          0.00s         0.00s  0.00s    +0.0%        
