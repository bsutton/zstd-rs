...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-exactsplit-broad-local.csv`

Commentary: Try an exact whole-vs-midpoint split compare for large Fastest Unknown non-text blocks, without the entropy-estimate gate.
...
build_ruzstd-cli                        855,908         894,099    850,952    +0.6%          0.06s         0.00s  0.07s    -16.7%       
decodecorpus_z000003                    51,006          53,328     51,006     +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000028                    98,592          105,226    97,095     +1.5%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000033                    532,333         571,529    525,509    +1.3%          0.02s         0.00s  0.03s    -50.0%       
