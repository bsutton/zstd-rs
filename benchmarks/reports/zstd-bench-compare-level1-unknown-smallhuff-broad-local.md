...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-smallhuff-broad-local.csv`

Commentary: Enabled the small-literal exact Huffman table search for CompressionFileType::Unknown at level 1, to test whether the remaining z000079 gap is partly entropy-side rather than matcher-side.
...
decodecorpus_z000079                    7,344           7,221      7,340      +0.1%          0.00s         0.00s  0.00s    +0.0%        
