...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-poetryyarn-config-broad-local.csv`

Commentary: Map poetry.lock and yarn.lock to ConfigText instead of the generic path.
...
generated_poetry.lock                  371             362        362        +2.4%          0.00s         0.00s  0.00s    +0.0%        
...
generated_yarn.lock                    398             393        390        +2.0%          0.00s         0.00s  0.00s    +0.0%        
