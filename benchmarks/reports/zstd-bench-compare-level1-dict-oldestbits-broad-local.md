...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-dict-oldestbits-broad-local.csv`

Commentary: DictionaryText keeps a closer current non-repeat candidate over farther oldest when the offset-code gap is at least 4 bits and oldest gains less than 2 bytes.
