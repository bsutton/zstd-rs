...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-nextrep-fulldense-vsretained-broad-local.csv`

Commentary: Large Unknown Fastest path: fully dense post-match suffix insertion after repeat-next-position wins instead of sparse long-match insertion.
...
build_ruzstd-cli                        855,679         894,099    855,655    +0.0%          0.06s         0.00s  0.06s    +0.0%        
...
decodecorpus_z000033                    532,632         571,529    532,637    -0.0%          0.02s         0.00s  0.02s    +0.0%        
