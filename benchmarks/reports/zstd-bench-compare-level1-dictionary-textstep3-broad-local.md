...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-dictionary-textstep3-broad-local.csv`
...
dict_dictionary.bin                     20,667          20,145     21,302     -3.1%          0.00s         0.00s  0.00s    +0.0%        
