...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-shortline-code6-vs5-broad-local.csv`
...
build_ruzstd-cli                        867,739         894,099    867,739    +0.0%          0.04s         0.00s  0.05s    -25.0%       
...
repo_main.rs                            2,140           2,101      2,141      -0.0%          0.00s         0.00s  0.00s    +0.0%        
repo_match_generator.rs                 23,085          22,797     22,591     +2.1%          0.00s         0.00s  0.00s    +0.0%        
```
