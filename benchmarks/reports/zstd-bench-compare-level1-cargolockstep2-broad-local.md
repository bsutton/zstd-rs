...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/tmp/cargolockstep2-broad-local.csv`

Commentary: DictionaryText: detect Cargo-lock-like short-line text and use the retained short-line probe step instead of forcing fully dense probing.
...
repo_Cargo.lock                        9,240           8,088      9,255      -0.2%          0.00s         0.00s  0.01s    +0.0%        
