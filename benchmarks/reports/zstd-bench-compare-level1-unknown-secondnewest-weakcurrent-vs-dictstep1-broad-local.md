...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-secondnewest-weakcurrent-vs-dictstep1-broad-local.csv`

Commentary: Experiment: let the retained Unknown non-text second-newest path also compete against a weak current min-length non-repeat match.
...
build_ruzstd-cli                        856,479         894,099    856,479    +0.0%          0.05s         0.00s  0.06s    -20.0%       
...
decodecorpus_z000033                    532,424         571,529    532,424    +0.0%          0.02s         0.00s  0.03s    -50.0%       
