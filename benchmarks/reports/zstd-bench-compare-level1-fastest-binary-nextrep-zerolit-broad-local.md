...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-fastest-binary-nextrep-zerolit-broad-local.csv`

Commentary: Level-1 binary-path CPU-cut experiment: keep Fastest non-text ip+1 repeat lookahead, but skip it at zero-literal positions.
...
--------------------------------------  --------------  ---------  ---------  -------------  ------------  -----  -------  -------------
build_libruzstd.rlib                    611,155         635,879    618,065    -1.1%          0.03s         0.00s  0.03s    +0.0%        
build_ruzstd-cli                        860,072         894,099    866,916    -0.8%          0.05s         0.00s  0.05s    +0.0%        
decodecorpus_z000003                    52,134          53,328     52,082     +0.1%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000028                    100,250         105,226    100,415    -0.2%          0.00s         0.00s  0.00s    +0.0%        
...
decodecorpus_z000033                    544,266         571,529    544,074    +0.0%          0.02s         0.00s  0.02s    +0.0%        
decodecorpus_z000053                    324             299        324        +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000054                    9,756           9,999      9,717      +0.4%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000059                    717             698        719        -0.3%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000062                    13              13         13         +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000077                    21              21         21         +0.0%          0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000079                    7,540           7,221      8,376      -11.1%         0.00s         0.00s  0.00s    +0.0%        
decodecorpus_z000080                    2,669           2,613      2,669      +0.0%          0.00s         0.00s  0.00s    +0.0%        
dict_NetworkManager-dispatcher.service  398             384        400        -0.5%          0.00s         0.00s  0.00s    +0.0%        
