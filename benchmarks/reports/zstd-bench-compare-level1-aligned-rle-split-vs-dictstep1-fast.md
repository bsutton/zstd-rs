...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-aligned-rle-split-vs-dictstep1-fast.csv`

Commentary: Guardrail check: split exactly one trailing 32 KiB RLE block when a full Fastest Unknown non-text block ends with a 32 KiB repeated suffix that continues into the next block.
