...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-config-flatsearch-broad-local.csv`

Commentary: Allow tiny ConfigText literals to keep searching for the smallest Huffman table even on flat distributions.
...
dict_dictionary.bin                    20,161          20,145     20,160     +0.0%          0.00s         0.00s  0.00s    +0.0%        
...
repo_Cargo.toml                        730             726        730        +0.0%          0.00s         0.00s  0.00s    +0.0%        
