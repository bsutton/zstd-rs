...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-code-config-allhuff-broad-local.csv`

Commentary: Experiment: widen CodeText and ConfigText exact Huffman table search from small literal sections to all literal sections at level 1.
...
decodecorpus_z000033                    544,266         571,529    544,266    +0.0%          0.03s         0.00s  0.02s    +33.3%       
