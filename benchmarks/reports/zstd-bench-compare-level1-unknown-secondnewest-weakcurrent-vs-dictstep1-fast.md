...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-unknown-secondnewest-weakcurrent-vs-dictstep1-fast.csv`

Commentary: Guardrail check: let the retained Unknown non-text second-newest path also compete against a weak current min-length non-repeat match.
