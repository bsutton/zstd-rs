...
Source CSV: `benchmarks/reports/zstd-bench-compare-level1-fse-repeat2048-broad-local.csv`

Commentary: Experiment: raise Fastest repeat-table reuse threshold from 64 to 2048 sequences to test large multi-block level-1 inputs.
...
decodecorpus_z000033                    544,266         571,529    544,266    +0.0%          0.04s         0.00s  0.03s    +25.0%       
