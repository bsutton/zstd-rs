...
Source CSV: `benchmarks/archive/tmp/restore-lockfile-secondnewest.csv`

Commentary: Restore check after rejecting lockfile current-entry long-hash.
...
dict_dictionary.bin                    20,160          20,145     20,160     +0.0%          0.57s         0.00s  1.56s    -173.7%      
