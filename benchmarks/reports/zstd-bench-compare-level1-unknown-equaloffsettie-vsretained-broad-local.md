...
Source CSV: `/home/bsutton/git/zstd-rs/benchmarks/archive/system-tmp/zstd-bench-compare-level1-unknown-equaloffsettie-vsretained-broad-local.csv`

Commentary: Large Unknown level-1: on equal-length non-repeat window candidates, keep the closer current candidate when it saves meaningful offset-code bits.
